const api = (() => {
  ...
  return {
    ...
    getRulesSection: (key) => req('GET', `/rules?section=${encodeURIComponent(key)}`),
    ...
    // Letterhead library (global, reusable) + letter body drafting.
    listCompanies: () => req('GET', '/letterhead/companies'),
    createCompany: (data) => req('POST', '/letterhead/companies', data),
    updateCompany: (id, data) => req('PUT', `/letterhead/companies/${id}`, data),
    deleteCompany: (id) => req('DELETE', `/letterhead/companies/${id}`),
    saveCompanyLogo: (id, png) => req('POST', `/letterhead/companies/${id}/logo`, { png }),
    companyLogoUrl: (id) => `/api/letterhead/companies/${id}/logo`,
    listSignatories: () => req('GET', '/letterhead/signatories'),
    createSignatory: (data) => req('POST', '/letterhead/signatories', data),
    updateSignatory: (id, data) => req('PUT', `/letterhead/signatories/${id}`, data),
    deleteSignatory: (id) => req('DELETE', `/letterhead/signatories/${id}`),
    saveSignature: (id, png) => req('POST', `/letterhead/signatories/${id}/signature`, { png }),
    signatureUrl: (id) => `/api/letterhead/signatories/${id}/signature`,
    draftLetter: (sessionId, data) => req('POST', `/sessions/${sessionId}/letters/draft`, data),
    draftCompany: (sessionId, data) => req('POST', `/sessions/${sessionId}/companies/draft`, data),
