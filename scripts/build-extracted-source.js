...
const sections = [
  {
    ...
    destination: 'rules/quick-reference.md and scenario/setting-overview.md',
    start: '## Introduction',
    end: '## What Now?',
  },
  {
  ...
  },
  {
    ...
    destination: 'rules/character-creation.md',
  ...
  },
  {
    ...
    destination: 'rules/core-rules.md, rules/combat.md, rules/damage-healing.md, rules/chases.md',
  ...
  },
  {
    ...
    destination: 'rules/magic.md and rules/spells.md',
    start: '## Vestigia',
  ...
  },
  {
    ...
    destination: 'scenario/npcs-and-beings.md and rules/demi-monde.md',
  ...
  },
  {
    ...
    destination: 'rules/advanced-rules.md and scenario/case-design.md',
  ...
  },
  {
    ...
    destination: 'rules/quick-reference.md',
...
const header = [
  ...
  '',
  'The final corpus must be logically ordered, paraphrased, compact, and written into `Rivers_of_London/rules/rules/` and `Rivers_of_London/rules/scenario/`.',
  '',
  includeBookshop
