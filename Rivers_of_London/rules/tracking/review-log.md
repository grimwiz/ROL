...
- Added canonical Bookshop NPC allocation: Warwick Anderson, Saffron Jackson, PC Karnam Singh, Ernie, and the Spirit of Books and Reading are imported from JSON-backed NPC sheets and allocated to the case. Reset restores their per-case working sheets.
