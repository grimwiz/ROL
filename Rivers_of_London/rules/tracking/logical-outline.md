...
| 02 | `scenario/02-policing-and-investigations.md` | Met structure, ranks, investigation stages, crime scenes, evidence, incident room, police powers, resources, acronyms. | `policing-and-gm-procedures` |
...
| 06 | `scenario/06-case-design.md` | Running cases, pacing, clues, source material, antagonist, hooks, scenes, campaign structure, props/tech. | `policing-and-gm-procedures`, `additional-rules` |
| 07 | `scenario/07-case-seeds.md` | Condensed original case seeds and reusable hook fragments. | `folly-and-london`, `additional-rules` |
...
- Keep all player character creation options in `03-character-creation` or `12-advanced-options`; scenario NPC summaries should not redefine PC creation.
