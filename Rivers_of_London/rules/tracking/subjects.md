...
| Pushing rolls | `02-core-resolution.md`, `04-skills.md` | Chapter 3, skill entries | extracted-draft | Generic pushing procedure and skill-specific push guidance drafted. |
| Bonus and penalty dice | `02-core-resolution.md`, `06-combat.md` | Chapter 3, combat, Appendix B | extracted-draft | Generic rule drafted; combat overflow to damage drafted. |
| Human limits and characteristic rolls | `02-core-resolution.md` | Chapter 3 | extracted-draft | INT rolls, human limits, group assistance, and Trying Your Luck routing drafted. |
| Luck rolls and spending Luck | `02-core-resolution.md`, `07-damage-and-healing.md`, `09-magic.md` | Chapter 3, damage, magic | extracted-draft | Core spending/recovery restrictions and wound-specific Luck uses drafted. |
| Opposed rolls | `02-core-resolution.md`, `06-combat.md` | Chapter 3 | extracted-draft | Tie handling, no-push rule, and combat-specific tie handling drafted. |
| Impairment | `01-character-model.md`, `02-core-resolution.md`, `07-damage-and-healing.md` | Chapter 3, Appendix B | extracted-draft | Damage-state interaction, mental cause checks, fumble range, composure effects, and recovery drafted. |
...
| Met ranks and structure | `scenario/policing-and-investigations.md` | Chapter 5 | unreviewed | Include enough for cases, not real-world exhaustive prose. |
| Investigation process | `scenario/policing-and-investigations.md` | Chapter 5 | unreviewed | Stages, crime scene, evidence, incident room, ABC, Six Ws, TIE. |
| Police powers | `scenario/policing-and-investigations.md` | Chapter 5 | unreviewed | Warrant card, stop/search, arrest, detention, interviews, caution. |
| Police resources and databases | `scenario/policing-and-investigations.md` | Chapter 5 | unreviewed | Forensics, firearms, FLO, comms/data, financial, pathology, HOLMES, PNC, forensic databases. |
| Police acronyms and slang | `scenario/policing-and-investigations.md` | Chapter 5 | needs-pdf-check | Markdown table is malformed around the final row. |
| Tone, safety, pacing, group handling | `scenario/gm-procedures.md` | Chapter 5 | unreviewed | Scenario-running advice; keep terse and table-actionable. |
...
| Case file design | `scenario/case-design.md` | Chapter 9 | unreviewed | Writing cases, source use, antagonist, hook, scenes, clues, conclusion. |
