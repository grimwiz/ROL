...
| Chapter 6: A Rogues' Gallery - scenario NPC summaries | 231-258 | `scenario/npcs-and-beings.md` | unreviewed | Scenario-facing NPC summaries and stat-block routing remain pending. Avoid reproducing long character prose. |
