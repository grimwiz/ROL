...
| Chapter 4: Newtonian Magic | 161-194 | `09-magic.md`, `10-spells.md` | partial draft | partly pdf-checked | 2026-05-22 | Checked: signare creation + Table 10 (transcribed in full). Still to check: vestigia detail, magic points, casting modifiers, HTD, and spell trees/prerequisites (feed `10-spells.md`). |
