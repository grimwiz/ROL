...
| Chapter 7: Welcome to London | 259-284 | `scenario/folly-and-london.md`, `scenario/case-seeds.md` | drafted | pdf-pending | 2026-06-02 (draft only) | Drafted from the `folly-and-london` source section, not yet PDF-gated. PDF check against printed p.259-284 still required: Folly building/room references, the magical organisations, the London gazetteer place-facts, the rivers/genii locorum, pub/nazareth rules, and the 12 case seeds. Bracketed location numbers need checking against the Map of Central London (p.270-271); printed p.284 is a chapter-divider with no text. |
...
| Chapter 7 drafted from the source section without the printed-PDF gate. | `scenario/folly-and-london.md`, `scenario/case-seeds.md` | Chapter 7, pages 259-284 | open 2026-06-02 | PDF-check the two drafts against printed p.259-284: place/organisation/river facts, pub and nazareth rules, the 12 case seeds, and bracketed map-location numbers against the Map of Central London (p.270-271). Until then both files stay `extracted-draft`. |
