...
| Chapter 1: Creating Characters | 43-78 | `01-character-model.md`, `03-character-creation.md` | drafted | pdf-pending | - | Check all character creation steps, occupation tables, advantages, starting resources, weapons, and Living Standards table. |
| Chapter 2: Skills | 79-102 | `04-skills.md` | drafted | pdf-pending | - | Check every skill entry, specialisation, difficulty bullet, pushed-roll note, Drive/Navigate ordering, and Read Lips/Ride split. |
| Chapter 3: Basic Rules | 103-160 | `02-core-resolution.md`, `05-advancement.md`, `06-combat.md`, `07-damage-and-healing.md`, `08-chases.md` | drafted | pdf-pending | - | Chapter 3 primary rules are drafted. PDF-check all step sequences, combat responses, ranged modifiers, damage/healing tables, chase flows, and vehicle tables before completion. |
| Chapter 4: Newtonian Magic | 161-194 | `09-magic.md`, `10-spells.md` | partial draft | pdf-pending | - | Magic procedure drafted. Check signare table, spell trees, spell prerequisites, spell effects, and HTD details against PDF. |
...
| Chapter 6: A Rogues' Gallery | 231-258 | `scenario/npcs-and-beings.md`, `11-demi-monde.md` | not drafted | pdf-pending | - | Need rules and scenario-useful summaries only; avoid reproducing long NPC prose. |
...
| Chapter 9: Additional Rules | 309-342 | `12-advanced-options.md`, `scenario/case-design.md` | not drafted | pdf-pending | - | Need optional PC rules, advanced combat/damage options, spells/enchantments, organisations, and case design. |
...
| Living Standards table order may be wrong in markdown. | `03-character-creation.md` | Chapter 1, pages 43-78 | open | Compare table directly with PDF before Chapter 1 can be complete. |
| Drive/Navigate difficulty bullets may be split or displaced. | `04-skills.md` | Chapter 2, pages 79-102 | open | Compare skill entries directly with PDF. |
| Read Lips/Ride page break may have displaced text. | `04-skills.md` | Chapter 2, pages 79-102 | open | Compare entries directly with PDF. |
| Advancement, combat, damage/healing, chases, and vehicle rules require PDF verification. | `05-advancement.md` through `08-chases.md` | Chapter 3, pages 103-160 | drafted-pdf-pending | Compare drafted procedures against the PDF, especially tables and step sequences, then close or record any gaps. |
| Spell catalog, spell prerequisites, and spell trees are not drafted. | `10-spells.md` | Chapter 4, pages 161-194 | open | Extract spell list from PDF-checked source; verify tree/table layout. |
| Signare random table is malformed in markdown. | `09-magic.md` or later tool appendix | Chapter 4, pages 161-194 | open | Decide whether to include a random signare generator; if included, transcribe/check against PDF. |
